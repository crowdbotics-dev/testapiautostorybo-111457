...
## Project Structure
    ...
    ├── testapiautostorybo_111457  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_111457`
...
2. Clone this repo and `cd testapiautostorybo_111457`
